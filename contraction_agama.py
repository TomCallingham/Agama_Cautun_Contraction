...
def contract_agama_potential(dm_pot, baryon_pot, fbar=0.157, rmax=500, rmin=0.05):
...
def contract_density_fit(density_DM, density_bar, mass_DM, mass_bar, f_bar=0.157):
   ...
   """
    ...
    # the last two terms account for transforming the DM mass into the
    # corresponding baryonic mass in DMO simulations
    eta_bar = mass_bar / mass_DM * (1. -f_bar) / f_bar
